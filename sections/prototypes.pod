...
prototype.  To see the prototype of a built-in keyword,
use the C<CORE::> form:
...
If you cannot emulate that function's argument handling (some core keywords),
C<prototype> will return C<undef> as well.
